...
3. [Player](../Game/Core/Player.prefab), which:
   * includes all relevant player control scripts (e.g. [Player](../Scripts/Core/Player.cs), [PlayerStateMachine](../Scripts/Core/PlayerStateMachine.cs), [PlayerController](../Scripts/Control/Controllers/PlayerController.cs), [PlayerMover](../Scripts/Control/Movement/PlayerMover.cs), etc. )
