...
public partial class @PlayerInput: IInputActionCollection2, IDisposable
{
    ...
    ~@PlayerInput()
    {
        ...
        Debug.Assert(!m_Menu.enabled, "This will cause a leak and performance issues, PlayerInput.Menu.Disable() has not been called.");
        Debug.Assert(!m_Admin.enabled, "This will cause a leak and performance issues, PlayerInput.Admin.Disable() has not been called.");
    }
