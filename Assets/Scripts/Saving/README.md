...
See the [README](../../../Packages/com.lowdefmustard.saving/README.md) from [com.lowdefmustard.saving](../../../Packages/com.lowdefmustard.saving/) for information on the saving system back-end.

## Reminder on a Saveable Entity's UID Configuration

It is crucially important to set an entity's `uniqueIdentifier` field appropriately:
